...
def payment_sum(counter, summ, counter1):
    ...
    while True:
        ...
        summ += summa
        counter += 1
        message_sum = 'C номера [' + str(i) + '](https://bill.bezlimit.ru/phone/card/view/' + str(i) + ') перевели деньги более '+ str(counter1) + ' раз! Сумма переводов: ' + str(summ) + ' р.!\n-------------------------\n'
    return message_sum
...
if fuck_number_list == {}:
    ...
    message = f'ВНИМАНИЕ!\nАномалия при переводе средств с номера!\n-------------------------\n'
