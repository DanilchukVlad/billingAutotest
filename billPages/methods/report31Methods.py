...
from billPages.locators.report31Locators import Report31Locators


class Report31Methods(Report31Locators, BasePage):

    def go_to_report31_page(self):
        self.go_to_site(self.report31_page_url)
